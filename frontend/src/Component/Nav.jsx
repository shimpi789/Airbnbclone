...
import logo from '../assets/staygenie.jpg'
...
function Nav() {
  ...
  let {listingdata,setListingData ,newListData,setNewListData,
   searchData,handleSearch,handleViewCard} = useContext(listingDataContext)
  ...
  return (
    <div className='fixed top-0 bg-[white] w-full z-50'>
        <div className='w-[100vw] min-h-[70px] border-b-[1px] border-[#dcdcdc] px-[20px] flex items-center justify-between md:px-[40px] '>
            <div><img src={logo} alt='logo' className='w-[90px]'/></div>
            ...
            <div className='w-[35%] relative hidden md:block'>
               ...
               <button className='absolute p-[10px] rounded-[50px] bg-[#020248] right-[2%] top-[4px]'><IoSearchSharp className='w-[20px] h-[20px] text-[white]'/></button>
            </div>
            <div className='flex items-center justify-center gap-[10px] relative'>
               ...
               {showpopup &&  <div className='w-[220px] h-[250px] absolute bg-slate-50 top-[110%] right-[3%] border-[1px] border-[#aaa9a9] z-50 rounded-lg md:right-[10%]'>
           ...
           {searchData?.length>0 && <div className='w-[100vw] h-[450px] flex flex-col gap-[20px] absolute top-[50%]
            overflow-auto left-[0] justify-start items-center'>
               <div className='max-w-[700px] w-[100vw] h-[300px] overflow-hidden flex flex-col
               bg-[#fefefd] p-[20px] rounded-lg border-[1px] border-[#a2a1a1] cursor-pointer' >

                  {
                     searchData.map((search)=>(<div className='border-b border-[black] p-[10px]' onClick={()=>handleClick(search._id)}>
