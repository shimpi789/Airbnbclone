  ...
  return (
    <div className='w-[100vw] h-[100vh] flex items-center justify-center relative'>
        ...
        <form action="" className='max-w-[900px] w-[90%] h-[600px] flex items-center justify-center 
         flex-col md:item-start gap-[10px]' onSubmit={handleSignUP}>
           ...
           <button className='px-[50px] py-[10px] bg-[#020248] text-[white] text-[18px] md:px-[100px] rounded-lg mt-[20px]' disabled={loading}>{loading?"Loading..":"SignUp"}</button>
